						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="<%=basePath%>getImg?id=${p.productId}"
												style="border: 1px solid #F7F7F0;height: 100px;width: 80px;"/>
								</a>
							</td>
						    ...
						    <%
								com.model.Product p=(com.model.Product)pageContext.findAttribute("p");
								int pid=p.getCategoryId();
								java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
								String catName=com.model.Category.findByCategoryId(con,pid);
						    %>
