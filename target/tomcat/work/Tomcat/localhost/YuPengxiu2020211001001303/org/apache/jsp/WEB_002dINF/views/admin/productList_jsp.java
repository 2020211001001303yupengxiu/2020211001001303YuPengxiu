 ...
 * Generated at: 2022-05-10 14:35:02 UTC
...
if(session.getAttribute("user")!=null){
      ...
      out.write("\t\t\t\t\t\t\t\tstyle=\"border: 1px solid #F7F7F0; height: 100px;width: 80px;\"/></a>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"cart_description\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<h4>productName </h4>\r\n");
      out.write("\t\t\t\t\t\t\t\t<p>Web ID: productId</p>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"cart_price\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<p>price</p>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"cart_quantity\">CategoryID</td>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"cart_total\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"cart_total_price\"> productDescription</p>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"\">\r\n");
